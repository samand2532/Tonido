...
PotDelta = csvread('PotDeltaPM.csv');
...
%%%%% Int Term
LagTableIntDelta = zeros(length(IntDelta),9);
for IntCount = 1:length(IntDelta)
    ...
    LagTableIntDelta(IntCount,1) = nk1;
    LagTableIntDelta(IntCount,2) = nk2;
    LagTableIntDelta(IntCount,3) = nl1;
    LagTableIntDelta(IntCount,4) = nl2;
    LagTableIntDelta(IntCount,5) = mk1;
    LagTableIntDelta(IntCount,6) = mk2;
    LagTableIntDelta(IntCount,7) = ml1;
    LagTableIntDelta(IntCount,8) = ml2;
