...
csvwrite('NMatLLL.csv',NMat);
LMat = zeros(length(AllBras));
UMat = zeros(length(AllBras));
VMat = zeros(length(AllBras));
%%% LMAT START
...
mk1ValVect = zeros(19,1);
mk2ValVect = zeros(19,1);
ml1ValVect = zeros(19,1);
ml2ValVect = zeros(19,1);
for pp = 1:(19^4)
...
toc
csvwrite('DeltaTermAllowedPositionLLL.csv',APAFinal)
